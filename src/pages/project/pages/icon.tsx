...
export default function Icondb() {
  ...
  const paragraphs = [
    'ICONDB는 아이콘을 사용하려는 사용자들을 위한 무료 웹 서비스로, 즉석으로 아이콘을 변경할 수 있습니다.',

    'ICONDB는 이런 기능을 제공합니다.'+
    ...
    '프로젝트에서 HTML, CSS, JavaScript, React, styled-components, Node.js, Express.js, MySQL, AWS 등 다양한 기술을 활용했습니다. ' +
