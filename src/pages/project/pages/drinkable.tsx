...
export default function Drinkable() {
  ...
  const paragraphs = [
    ...
    '이 프로젝트는 TypeScript 및 백엔드 공부를 목적으로 개발한 개인 프로젝트입니다.' +
      '백엔드에 대한 지식이 부족했기 때문에 DB 설계 및 Node.js 학습에 긴 시간이 소요되었지만, 구글링 및 여러 자료들을 자세히 살펴보며 백엔드 코드를 완성할 수 있었습니다.',

    '해당 프로젝트는 HTML, CSS, TypeScript, React, style-components, Node.js, Express, MySQL과 같은 기술을 사용하였습니다.' +
      'TypeScript 및 Node.js공부를 통해 프론트엔드 지식을 향상시키는 동시에 백엔드와의 협업 시 원할한 의사소통 능력을 키울 수 있는 경험을 얻었습니다.',
