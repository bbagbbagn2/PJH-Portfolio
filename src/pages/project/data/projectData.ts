...
export const projectsData: Project[] = [
  {
    ...
    description: [
      ...
      '이 프로젝트는 기존 아이콘 공유 플랫폼의 장점을 분석하고, 개선점을 반영해 완성되었습니다. 핵심저으로, 사용자 관련 시스템(소셜 로그인, 팔로우, 프로필 변경), 아이콘 관련 기능(다운로드, 업로드, 좋아요), 검색 엔진(제목, 사용자, 해시태그 검색), 그리고 SVG 아이콘 편집 기능을 플랫폼 내에서 구현했습니다. 저는 프론트엔드 개발 뿐만 아니라 프로젝트 기획, 배포까지 전 과정을 진행했습니다. ',
